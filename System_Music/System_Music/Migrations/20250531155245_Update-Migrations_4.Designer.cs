...
namespace System_Music.Migrations
{
    ...
    [Migration("20250531155245_Update-Migrations_4")]
    partial class UpdateMigrations_4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("System_Music.Models.SqlModels.Video", b =>
                {
                    b.Property<string>("EncodeId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("ArtistsNames")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<string>("Mp4_1080")
                        .IsRequired()
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");

                    b.Property<string>("Mp4_480")
                        .IsRequired()
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");

                    b.Property<string>("Mp4_720")
                        .IsRequired()
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
            ...
            modelBuilder.Entity("System_Music.Models.SqlModels.VideoArtist", b =>
                {
                    b.Property<string>("VideoEncodeId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("ArtistId")
                        .HasColumnType("int");

                    b.Property<int>("VideoArtistId")
                        .HasColumnType("int");

                    b.HasKey("VideoEncodeId", "ArtistId");

                    b.HasIndex("ArtistId");

                    b.ToTable("VideoArtists");
                });
            ...
            modelBuilder.Entity("System_Music.Models.SqlModels.VideoArtist", b =>
                {
                    ...
                    b.HasOne("System_Music.Models.SqlModels.Video", "Video")
                        .WithMany("VideoArtists")
                        .HasForeignKey("VideoEncodeId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
